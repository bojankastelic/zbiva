...
class SummaryForm(ResourceForm):
    ...
    def load(self, lang):
        self.data['important_dates'] = {
            ...
            'domains': {'important_dates' : Concept().get_e55_domain('BEGINNING_OF_EXISTENCE_TYPE.E55', lang) + Concept().get_e55_domain('END_OF_EXISTENCE_TYPE.E55', lang)}
        }
        ...
        if self.resource:
            if self.resource.entitytypeid in ('HERITAGE_RESOURCE.E18', 'HERITAGE_RESOURCE_GROUP.E27'):            
                self.data['RESOURCE_TYPE_CLASSIFICATION.E55'] = {
                    ...
                    'domains': {'RESOURCE_TYPE_CLASSIFICATION.E55' : Concept().get_e55_domain('RESOURCE_TYPE_CLASSIFICATION.E55', lang)}
                }

            self.data['NAME.E41'] = {
                'branch_lists': self.get_nodes('NAME.E41'),
                'domains': {'NAME_TYPE.E55' : Concept().get_e55_domain('NAME_TYPE.E55', lang)}
                # 'defaults': {
            ...
            self.data['KEYWORD.E55'] = {
                ...
                'domains': {'KEYWORD.E55' : Concept().get_e55_domain('KEYWORD.E55', lang)}
            }
    ...
    def load(self, lang):
        if self.resource:
            self.data['EXTERNAL_RESOURCE.E1'] = {
                ...
                'domains': {
                    'EXTERNAL_XREF_TYPE.E55': Concept().get_e55_domain('EXTERNAL_XREF_TYPE.E55', lang),
                }
            }
    ...
    def load(self, lang):
        ...
        if self.resource:
            ...
            self.data['PHASE_TYPE_ASSIGNMENT.E17'] = {
                ...
                'domains': {
                    'ACTIVITY_TYPE.E55': Concept().get_e55_domain('ACTIVITY_TYPE.E55', lang),
                }
            }
    ...
    def load(self, lang):
        if self.resource:
            ...
            self.data['BEGINNING_OF_EXISTENCE.E63'] = {
                ...
                'domains': {
                    'BEGINNING_OF_EXISTENCE_TYPE.E55' : Concept().get_e55_domain('BEGINNING_OF_EXISTENCE_TYPE.E55', lang)
                }
            }
            ...
            self.data['END_OF_EXISTENCE.E64'] = {
                ...
                'domains': {
                    'END_OF_EXISTENCE_TYPE.E55' : Concept().get_e55_domain('END_OF_EXISTENCE_TYPE.E55', lang)
                }
            }
            try:
                self.data['primaryname_conceptid'] = self.data['NAME.E41']['domains']['NAME_TYPE.E55'][3]['id']
    ...
    def load(self, lang):
        if self.resource:
            ...
            self.data['COMPONENT.E18'] = {
                ...
                'domains': {
                    'CONSTRUCTION_TECHNIQUE.E55': Concept().get_e55_domain('CONSTRUCTION_TECHNIQUE.E55', lang),
                    'MATERIAL.E57' : Concept().get_e55_domain('MATERIAL.E57', lang),
                    'COMPONENT_TYPE.E55' : Concept().get_e55_domain('COMPONENT_TYPE.E55', lang)
                }
            }
            self.data['MODIFICATION_EVENT.E11'] = {
                'branch_lists': self.get_nodes('MODIFICATION_EVENT.E11'),
                'domains': {
                    'MODIFICATION_TYPE.E55': Concept().get_e55_domain('MODIFICATION_TYPE.E55', lang),
                }
            }
...
class ClassificationForm(ResourceForm):
    ...
    def load(self, lang):
        ...
        self.data = {
            'data': [],
            'domains': {
                'HERITAGE_RESOURCE_TYPE.E55': Concept().get_e55_domain('HERITAGE_RESOURCE_TYPE.E55', lang),
                'HERITAGE_RESOURCE_USE_TYPE.E55' : Concept().get_e55_domain('HERITAGE_RESOURCE_USE_TYPE.E55', lang),
                'CULTURAL_PERIOD.E55' : Concept().get_e55_domain('CULTURAL_PERIOD.E55', lang),
                'STYLE.E55' : Concept().get_e55_domain('STYLE.E55', lang),
                'ANCILLARY_FEATURE_TYPE.E55' : Concept().get_e55_domain('ANCILLARY_FEATURE_TYPE.E55', lang)
            }
        }
    ...
    def load(self, lang):
        if self.resource:
            ...
            self.data['TITLE.E41'] = {
                ...
                'domains': {'TITLE_TYPE.E55' : Concept().get_e55_domain('TITLE_TYPE.E55', lang)}
            }

            self.data['IDENTIFIER.E42'] = {
                'branch_lists': self.get_nodes('IDENTIFIER.E42'),
                'domains': {
                    'IDENTIFIER_TYPE.E55' : Concept().get_e55_domain('IDENTIFIER_TYPE.E55', lang)
                }
            }
            ...
            self.data['INFORMATION_CARRIER.E84'] = {
                ...
                'domains': {
                    'INFORMATION_CARRIER_FORMAT_TYPE.E55' : Concept().get_e55_domain('INFORMATION_CARRIER_FORMAT_TYPE.E55', lang)
                }
            }

            self.data['LANGUAGE.E55'] = {
                'branch_lists': self.get_nodes('LANGUAGE.E55'),
                'domains': {'LANGUAGE.E55' : Concept().get_e55_domain('LANGUAGE.E55', lang)}
            }
...
class DescriptionForm(ResourceForm):
    ...
    def load(self, lang):
        description_types = Concept().get_e55_domain('DESCRIPTION_TYPE.E55', lang)
        try:
    ...
    def load(self, lang):
        if self.resource:
            self.data['MEASUREMENT_TYPE.E55'] = {
                ...
                'domains': {
                    'MEASUREMENT_TYPE.E55' : Concept().get_e55_domain('MEASUREMENT_TYPE.E55', lang),
                    'UNIT_OF_MEASUREMENT.E55': Concept().get_e55_domain('UNIT_OF_MEASUREMENT.E55', lang)
                }
            }
...
class ConditionForm(ResourceForm):
    ...
    def load(self, lang):
        ...
        self.data = {
            'data': [],
            'domains': {
                'DISTURBANCE_TYPE.E55': Concept().get_e55_domain('DISTURBANCE_TYPE.E55', lang),
                'CONDITION_TYPE.E55' : Concept().get_e55_domain('CONDITION_TYPE.E55', lang),
                'THREAT_TYPE.E55' : Concept().get_e55_domain('THREAT_TYPE.E55', lang),
                'RECOMMENDATION_TYPE.E55' : Concept().get_e55_domain('RECOMMENDATION_TYPE.E55', lang)
            }
        }
...
class LocationForm(ResourceForm):
    ...
    def load(self, lang):
        self.data['SPATIAL_COORDINATES_GEOMETRY.E47'] = {
            ...
            'domains': {
                'GEOMETRY_QUALIFIER.E55': Concept().get_e55_domain('GEOMETRY_QUALIFIER.E55', lang)
            }
        }
        ...
        self.data['PLACE_ADDRESS.E45'] = {
            ...
            'domains': {
                'ADDRESS_TYPE.E55': Concept().get_e55_domain('ADDRESS_TYPE.E55', lang)
            }
        }
        ...
        self.data['SETTING_TYPE.E55'] = {
            ...
            'domains': {
                'SETTING_TYPE.E55': Concept().get_e55_domain('SETTING_TYPE.E55', lang)
            }
        }
        ...
        self.data['ADMINISTRATIVE_SUBDIVISION.E48'] = {
            ...
            'domains': {
                'ADMINISTRATIVE_SUBDIVISION_TYPE.E55': Concept().get_e55_domain('ADMINISTRATIVE_SUBDIVISION_TYPE.E55', lang)
            }
        }
...
class RelatedFilesForm(ResourceForm):
    ...
    def load(self, lang):
        ...
        self.data['current-files'] = {
            'branch_lists': data,
            'domains': {
                'RELATIONSHIP_TYPES.E32': Concept().get_e55_domain('ARCHES_RESOURCE_CROSS-REFERENCE_RELATIONSHIP_TYPES.E55', lang),
                'TITLE_TYPE.E55': Concept().get_e55_domain('TITLE_TYPE.E55', lang),
                'DESCRIPTION_TYPE.E55': Concept().get_e55_domain('DESCRIPTION_TYPE.E55', lang)
            }
        }
    ...
    def load(self, lang):
        if self.resource:
            self.data['PROTECTION_EVENT.E65'] = {
                ...
                'domains': {
                    'TYPE_OF_DESIGNATION_OR_PROTECTION.E55' : Concept().get_e55_domain('TYPE_OF_DESIGNATION_OR_PROTECTION.E55', lang)
                }
            }
    ...
    def load(self, lang):
        if self.resource:
            self.data['PHASE_TYPE_ASSIGNMENT.E17'] = {
                ...
                'domains': {
                    'ACTOR_TYPE.E55' : Concept().get_e55_domain('ACTOR_TYPE.E55', lang),
                    'CULTURAL_PERIOD.E55' : Concept().get_e55_domain('CULTURAL_PERIOD.E55', lang)
                }
            }
    ...
    def load(self, lang):
        if self.resource:
            self.data['APPELLATION.E41'] = {
                ...
                'domains': {
                    'NAME_TYPE.E55' : Concept().get_e55_domain('NAME_TYPE.E55', lang)
                }
            }
            ...
            self.data['KEYWORD.E55'] = {
                'branch_lists': self.get_nodes('KEYWORD.E55'),
                'domains': {
                    'KEYWORD.E55' : Concept().get_e55_domain('KEYWORD.E55', lang)}
            }
            try:
    ...
    def load(self, lang):
        if self.resource:
            self.data['PHASE_TYPE_ASSIGNMENT.E17'] = {
                'branch_lists': datetime_nodes_to_dates(self.get_nodes('PHASE_TYPE_ASSIGNMENT.E17')),
                'domains': {
                    'HISTORICAL_EVENT_TYPE.E55' : Concept().get_e55_domain('HISTORICAL_EVENT_TYPE.E55', lang),
                    'CULTURAL_PERIOD.E55' : Concept().get_e55_domain('CULTURAL_PERIOD.E55', lang)
                }
            }
...
class EvaluationForm(ResourceForm):
    ...
    def load(self, lang):
        ...
        self.data = {
            'data': [],
            'domains': {
                'STATUS.E55': Concept().get_e55_domain('STATUS.E55', lang),
                'EVALUATION_CRITERIA_TYPE.E55' : Concept().get_e55_domain('EVALUATION_CRITERIA_TYPE.E55', lang),
                'INTEGRITY_TYPE.E55' : Concept().get_e55_domain('INTEGRITY_TYPE.E55', lang),
                'ELIGIBILITY_REQUIREMENT_TYPE.E55' : Concept().get_e55_domain('ELIGIBILITY_REQUIREMENT_TYPE.E55', lang)
            }
        }
...
class RelatedResourcesForm(ResourceForm):
    ...
    def load(self, lang):
        ...
        relationship_types = Concept().get_e55_domain('ARCHES_RESOURCE_CROSS-REFERENCE_RELATIONSHIP_TYPES.E55', lang)
...
class DistrictClassificationForm(ResourceForm):
    ...
    def load(self, lang):
        ...
        self.data = {
            'data': [],
            'domains': {
                'HERITAGE_RESOURCE_GROUP_TYPE.E55': Concept().get_e55_domain('HERITAGE_RESOURCE_GROUP_TYPE.E55', lang),
                'HERITAGE_RESOURCE_GROUP_USE_TYPE.E55' : Concept().get_e55_domain('HERITAGE_RESOURCE_GROUP_USE_TYPE.E55', lang),
                'CULTURAL_PERIOD.E55' : Concept().get_e55_domain('CULTURAL_PERIOD.E55', lang),
                'ANCILLARY_FEATURE_TYPE.E55' : Concept().get_e55_domain('ANCILLARY_FEATURE_TYPE.E55', lang)
            }
        }
    ...
    def load(self, lang):
        if self.resource:
            self.data['RESOURCE_CREATION_EVENT.E65'] = {
                ...
                'domains': {
                    'INFORMATION_RESOURCE_TYPE.E55' : Concept().get_e55_domain('INFORMATION_RESOURCE_TYPE.E55', lang)
                }
            }
            ...
            self.data['RIGHT_TYPE.E55'] = {
                ...
                'domains': {
                    'RIGHT_TYPE.E55' : Concept().get_e55_domain('RIGHT_TYPE.E55', lang)
                }
            }
